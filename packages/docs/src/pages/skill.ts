...
Every component in the library: ${componentList}. Each has a docs page with full markup, variants, and options. See https://ui.erikt.me/llms.txt for the exact URL of any one not covered by an example above.
`;
}
